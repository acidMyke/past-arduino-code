...
#if !defined(FUNCTION_START) || !defined(STRING_START) || !defined(BYTE_START)
#error FUNCTION_START or STRING_START or BYTE_START is not define. Please define it before #include "SyncCommand.h"
#endif
